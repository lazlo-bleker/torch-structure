...
from torch_structure.optimizer import VariableConfig, ObjectiveConfig, ConstraintConfig, VariableConfig, SolverConfig, Optimizer
...
dv_config_list = [
    VariableConfig("Deviation Forces", data.force, force_mask)
]
...
logger_config = VariableConfig()
optimizer = Optimizer(data, solver_config, dv_config_list, obj_func_config_list, constr_func_config_list, logger_config)
