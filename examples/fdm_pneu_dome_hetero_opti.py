...
result = minimize(
    fun=same_lengths,
    args=(data, hetero_data, eps, max_its),
...
#data.plot(title="Pneu Dome", legend=False, lw_scale = 0.1)
...
plt.ylabel('Sum of Squared Deviations from Mean Length')
plt.yscale('log')
plt.grid(True)
plt.show()
