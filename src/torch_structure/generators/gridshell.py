...
class GridShell:
    ...
    def generate_graph(self, n, boundary_density, pattern, diagonals, centroid_support, unsupported_boundaries,
        ...
        for i in range(n):
            ...
            boundary_curve = self.quadratic_bezier(start_boundary, control_point, end_boundary, boundary_density*2 + 3)[1:-1]
        ...
        for i in range(n):
            ...
            boundary_2 = [f'boundary_{(i + 1) % n}_{j}' for j in range(0, boundary_density)]
            ...
            boundary_5 = [f'boundary_{i}_{j}' for j in range(0, 2*boundary_density + 1)]
